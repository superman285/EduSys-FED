...
export const createOrUpdateCourse = (data: SaveOrUpdateReq):AxiosPromise<SaveOrUpdateRes> => {
  return request({
    method: 'POST',
...
export const uploadCourseImage = (data: File | FormData, onUploadProgress: (progressEvent: ProgressEvent) => void):AxiosPromise<UploadImgRes> => {
...
export const getCourseById = (courseId: number | string):AxiosPromise<GetCourseRes> => {
  return request({
    method: 'GET',
